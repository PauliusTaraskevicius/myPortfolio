        ...
        <div className="contact-form flex justify-center" id='contact'>
            ...
            />
               ...
               <div className="flex space-x-5 mt-3">
                   <input type="text" name="name" id="formborder" placeholder="Your Name" className="p-2 w-1/2 shadow-lg" required/>
               ...
               <div className="flex items-baseline space-x-2 mt-2">
                   ...
                   <p className="text-white-600 text-sm text-gray-500">I consent to having this website store my submitted information so they can respond to my inquiry.</p>
               </div>
               <button type="submit" value="Submit" className="submitSubscribeBtn w-full mt-6 text-white bg-black font-semibold p-3 rounded-full ">Submit</button>
